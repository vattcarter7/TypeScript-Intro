...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/models/Snyc.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function User(attrs) {
    ...
    this.sync = new Snyc_1.Sync(rootUrl);
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./Snyc":"src/models/Snyc.ts","./Attributes":"src/models/Attributes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
